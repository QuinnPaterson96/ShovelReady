...
- **M0 â€” Scope:** select one customer decision, actual fixed design, municipality and supported pathway. Provider research is non-blocking.
- **M1 â€” Technical proof:** one real fixed small design, about three reviewed site/placement fixtures, and approximately 5â€“8 supported checks, from saved source/extraction through reviewed publication to evidence display. Counts guide effort, not correctness claims.
- **M2 â€” User-tested MVP:** protected deployed demo, working CI/CD and recovery, roughly 20â€“30 real enquiries, measured net user effort and consequential errors.
- **M3 â€” Expansion experiment:** a second municipality only after the first workflow shows value.

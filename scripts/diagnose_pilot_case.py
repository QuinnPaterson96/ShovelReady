...
from app.contracts.inputs import (  # noqa: E402
    DesignRevision,
    GeometryFact,
    PlacementRevision,
    SiteRevision,
)
from app.contracts.rules import RuleContent, RuleReference  # noqa: E402
from app.evaluation.payloads import EvaluationRequest, InputRefs, MeasuredFact  # noqa: E402

ROOT = Path(__file__).resolve().parents[1]
ANNOTATIONS = ROOT / "docs/case-diagnostics/pilot/annotations.json"
MANIFEST = ROOT / "docs/research/case-readiness/plan-measurements/sources.json"
